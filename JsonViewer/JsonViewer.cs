    ...
    public partial class JsonViewer : UserControl
    {
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtJson.Text = StringUtils.Unescape(json, unescapeOptions: uOptions, removeQuotes: false);
            }
            catch (Exception ex)
            {
                ShowException(ex);
        ...
        private void btnPaste_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                StringEscapeOptions seOptions = new StringEscapeOptions(escapeKind: StringEscapeKind.EscapeNonAscii, escapeSurrogatePairs: true);
                CharUnescapeOptions uOptions = new CharUnescapeOptions(escapeLanguage: CharEscapeLanguage.CSharp, isUnrecognizedEscapeVerbatim: true);
                txtJson.Text= StringUtils.Escape(json, stringEscapeOptions: seOptions, charEscapeOptions: ceOptions, addQuotes: false);
            }
            catch (Exception ex)
            {
                ShowException(ex);
